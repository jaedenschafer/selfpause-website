...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: { canonical: `/mindset/${params.slug}` },
    openGraph: {
      title: page.title,
      description: page.metaDescription,
      type: 'article',
...
export default function MindsetSubPage({ params }) {
  ...
  const articleJsonLd = {
    ...
    mainEntityOfPage: `https://selfpause.com/mindset/${params.slug}`,
  };
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Mindset', item: 'https://selfpause.com/mindset' },
    ...
    <>
      ...
      <nav aria-label="Breadcrumb" className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 lg:pt-28">
        <ol className="flex items-center gap-2 text-sm text-gray-400">
          ...
          <li>/</li>
          <li><Link href="/mindset" className="hover:text-teal-500 transition-colors">Mindset</Link></li>
          <li>/</li>
