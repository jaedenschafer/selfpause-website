...
import { getLawOfAttractionPage, getAllLawOfAttractionSlugs } from '../../../lib/law-of-attraction';
import { notFound } from 'next/navigation';

export async function generateStaticParams() {
  const slugs = getAllLawOfAttractionSlugs();
...
export default function LawOfAttractionSubPage({ params }) {
  const page = getLawOfAttractionPage(params.slug);
  if (!page) notFound();
    ...
    <>
      ...
      <section className="py-16 lg:py-20 bg-cream-200">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-8">
            <Link href="/law-of-attraction" className="text-teal-600 hover:text-teal-700 font-medium">
              &larr; Browse all law of attraction topics
            </Link>
          </div>
        </div>
      </section>
